...
/* MÉTRICAS ULTRA REDONDEADAS */
.metric-container {
    background: white;
    border-radius: 35px; /* Curvas extremas tipo píldora */
    padding: 40px 20px;
...
/* TIPOGRAFÍA GLOBAL */
h1 { text-align: center; font-weight: 900; color: #111827; font-size: 3.5rem !important; margin-bottom: 0.5rem !important; }
h2 { text-align: center; font-weight: 800; color: #111827; margin-top: 3rem !important; margin-bottom: 2rem !important; font-size: 2.2rem !important;}
.sub-headline { text-align: center; font-size: 1.3rem; color: #4B5563; margin-bottom: 3rem; font-weight: 500;}
.highlight-text { color: #FF0080; font-weight: 900; }
</style>
...
with p1:
    ...
    <div class="price-card-pro">
        <h4 style="color:#6B7280; font-weight:800; margin-bottom:0;">📦 SYNERGY PRO ENGINE</h4>
        <h1 style="color:#111827; font-size:3rem; margin-top:0;">$497 USD</h1>
        <p style="color:#4B5563; font-size:1rem; margin-bottom:1.5rem;">The autonomous base engine for agencies and entrepreneurs demanding immediate scale.</p>
        <p style="margin-bottom:0.5rem; font-size:1.1rem;">✔️ <b>5 Autonomous Extraction Agents</b></p>
        <p style="margin-bottom:0.5rem; font-size:1.1rem;">✔️ Engine Evolution Protocol (90 days)</p>
        <p style="margin-bottom:2rem; font-size:1.1rem;">✔️ Standard Lead Profiling</p>
    </div>
    <br>
    """, unsafe_allow_html=True)
...
with p2:
    ...
    <div class="price-card-elite">
        <h4 style="color:#6B7280; font-weight:800; margin-bottom:0;">💎 SYNERGY ELITE SWARM</h4>
        <h1 style="color:#111827; font-size:3rem; margin-top:0;">$997 USD</h1>
        <p style="color:#4B5563; font-size:1rem; margin-bottom:1.5rem;">Full infrastructure with remote Telegram control for high-volume operations.</p>
        <p style="margin-bottom:0.5rem; font-size:1.1rem;">✔️ <b>20 Autonomous Agents + Manager</b></p>
        <p style="margin-bottom:0.5rem; font-size:1.1rem;">✔️ <b>Lifetime Evolution Protocol Access</b></p>
        <p style="margin-bottom:2rem; font-size:1.1rem;">✔️ Advanced Psychological Profiling</p>
    </div>
    <br>
    """, unsafe_allow_html=True)
